      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="glass-card p-8 rounded-2xl mb-16">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              <h2 className="text-2xl font-bold mb-8 text-gradient">Advanced Features</h2>
              
              <FeatureItem 
                icon={Award}
                title="Professional Certification"
                description="Earn recognized certificates as you progress through our comprehensive learning paths."
              />
              
              <FeatureItem 
                icon={BookOpen}
                title="Interactive Learning"
                description="Engaging lessons with real-time feedback to help you master sign language faster."
              />
              
              <FeatureItem 
                icon={Clock}
                title="Real-Time Translation"
                description="Instant translation with minimal delay for seamless communication experiences."
              />
              
              <div className="glass-card bg-gradient-to-br from-handsy-primary/10 to-handsy-quaternary dark:from-handsy-primary/20 dark:to-transparent p-6 rounded-xl">
                <h3 className="text-lg font-medium mb-2 flex items-center">
                  <CheckCircle className="text-green-500 mr-2" size={20} />
                  Exclusive Beta Features
                </h3>
                <p className="text-gray-600 dark:text-gray-300 text-sm">
                  Join our beta program to access upcoming features before they're publicly released, including AI-powered gesture recognition and custom vocabulary building.
                </p>
              </div>
            </div>
          </div>
