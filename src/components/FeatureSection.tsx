  ...
  return (
    <section className="py-14 relative overflow-hidden">
      <div className="container mx-auto px-4 md:px-6">
        ...
        {/* Main Features - using grid with animation cards */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12 max-w-6xl mx-auto">
          {features.map((feature, index) => (
            <div 
              key={index} 
              className="glass-card group-feature p-6 rounded-xl hover:shadow-xl transition-all duration-300 hover:translate-y-[-5px]"
            >
              <div className="feature-icon bg-handsy-primary/10 dark:bg-handsy-primary/20 mx-auto mb-4">
                {feature.icon}
              </div>
              <div className="text-center">
                <h3 className="text-xl font-semibold mb-2 transition-colors">{feature.title}</h3>
        ...
        <div className="max-w-4xl mx-auto">
          <h3 className="text-2xl font-semibold mb-6 text-center">Everything You Need</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
            {additionalFeatures.map((feature, index) => (
              <div key={index} className="flex items-center gap-2 p-3 glass-card hover:translate-y-[-5px] transition-all duration-300">
                <div className="rounded-full bg-handsy-primary/20 p-1 shrink-0">
                  <Check size={16} className="text-handsy-primary" />
                </div>
